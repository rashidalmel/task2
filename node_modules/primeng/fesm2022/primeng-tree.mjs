...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(UITreeNode, { className: "UITreeNode", filePath: "tree.ts", lineNumber: 179 }); })();
/**
 * Tree is used to display hierarchical data.
 * @group Components
 */
